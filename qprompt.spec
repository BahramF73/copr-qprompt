...
Patch0:         qprompt-disable-big-font-resources.patch
...
%changelog
* Tue Jul 28 2026 COPR Builder <builder@example.invalid> - 2.0.2-3
- Disable BIG_RESOURCES for embedded fonts to avoid a crash while reading Qt resources
